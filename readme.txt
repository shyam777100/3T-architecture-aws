...
Functionality:
a. Distributes incoming client requests to the web tier EC2 instances.
b. Ensures even distribution of traffic for better performance and reliability.
c. Performs health checks to ensure only healthy instances receive traffic.

2. Web Tier
a. Role: Serves the front-end of the application and redirects API calls.
b. Components:
...
a. Role: Manages traffic between the web tier and the application tier.
b. Functionality:
...
4. Application Tier
a. Role: Handles the application logic and processes API requests.
b. Components:
...
a. Role: Provides reliable and scalable data storage.
b. Functionality:
